import StatusCards from "@/app/components/manage-application-tracker/StatusCards";
...
const dummyStudents= [
  {
    id: 1,
    schoolName: "Sarah Johnson",
    applicationType: "Job Application",
    submissionDate: "14 Oct 2025",
    courses: 5,
    status: "Approved",
    initials: "SJ"
...
const getStatusColor = (status: string) => {
  switch (status) {
    ...
    case "In Review" : return "bg-[#FCFCDC] text-[#827300]"
    default:
      return "bg-[#F5F5F5] text-[#1A1A1A]";
  }
};
...
export default function page() {
  return (
    <div>
      <div className="pb-5">
        <h1 className="text-2xl font-semibold ">Manage Application Tracker</h1>
      ...
      >
        <div>
          ...
          <p className="text-light-gray ">
            Manage and view all students enrolled in your platform
          </p>
        </div>
          ...
          <table className="w-full text-left border-collapse  ">
            <thead>
              <tr className="border-b border-black/10 text-navigate">
                <th className="py-2  pl-8">School Name</th>
                <th className="py-2 pl-8">Application Type</th>
                <th className="py-2 px-4 text-center">Submission Date</th>
            ...
            <tbody>
              {dummyStudents.map((student) => (
                ...
                >
                  ...
                  <td className="py-3 px-4 text-thin-gray">{student.applicationType}</td>
                  <td className="py-3 px-4 text-center">{student.submissionDate}</td>
          ...
          {dummyStudents.map((student) => (
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <p className="font-semibold text-navigate text-base">{student.schoolName}</p>
                  <p className="text-thin-gray text-sm">{student.applicationType}</p>
                </div>
              </div>
              ...
              <div className=" flex flex-col text-sm text-navigate">
                <div className="flex items-center gap-4">
                  ...
                  <p className="font-medium w-28 wrap-anywhere">Submission Date</p>
                  <span>:</span>
                  <p className="flex-1">{student.submissionDate}</p>
