...
export default function EditQuizModal({ onClose }: ModalProps) {
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-999 px-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-lg p-6 relative max-h-[95vh] overflow-y-auto scrollbar-hide">
        ...
        <h2 className="text-xl font-semibold text-navigate ">Edit Quiz</h2>
        ...
        <div className="mt-6 space-y-4">
          ...
          <div>
            ...
            <div className="text-thin-gray w-full px-4 py-5 rounded-2xl bg-search-bar-bg flex flex-row items-center gap-2">
              <span className="text-2xl text-navigate font-normal">45</span>
              attempts
            </div>
          </div>
        </div>
